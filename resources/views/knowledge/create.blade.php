...
<div class="p-6 md:p-10 max-w-4xl mx-auto animate-fade-in-up">
    ...
    <div class="flex items-center gap-4 mb-10">
        <div class="w-12 h-12 bg-gradient-to-br from-secondary-600 to-primary-600 rounded-xl flex items-center justify-center shadow-[0_0_15px_rgba(63, 158, 143,0.3)]">
            <i data-lucide="book-plus" class="w-6 h-6 text-gray-900 dark:text-white"></i>
        </div>
        <div>
            <h2 class="text-3xl font-black text-gray-900 dark:text-white">إضافة مقال جديد</h2>
            <p class="text-gray-600 dark:text-gray-400 mt-1 font-medium">قم بإثراء قاعدة المعرفة بمقال أو حل جديد</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-[#1a1a24] rounded-3xl shadow-xl border border-gray-200 dark:border-gray-800 p-8 md:p-12 relative overflow-hidden">
        ...
        <form method="POST" action="/knowledge" class="space-y-10 relative z-10">
            ...
            <div class="group">
                <label class="block text-sm font-bold text-gray-600 dark:text-gray-400 mb-2 group-focus-within:text-primary-400 transition-colors">عنوان المقال <span class="text-primary-500">*</span></label>
                <div class="relative">
            ...
            <div class="group">
                <label class="block text-sm font-bold text-gray-600 dark:text-gray-400 mb-2 group-focus-within:text-primary-400 transition-colors">التصنيف <span class="text-primary-500">*</span></label>
                <div class="relative">
                    <select name="category_id" required 
                        class="w-full bg-transparent border-0 border-b-2 border-gray-300 dark:border-gray-700 px-0 py-3 text-gray-900 dark:text-white text-lg focus:ring-0 focus:border-primary-500 transition-colors appearance-none outline-none">
                        <option value="" class="bg-gray-200 dark:bg-gray-900 text-gray-500">-- اختر التصنيف --</option>
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}" class="bg-gray-200 dark:bg-gray-900 text-gray-900 dark:text-white" {{ old('category_id') == $category->id ? 'selected' : '' }}>
            ...
            <div class="group">
                <label class="block text-sm font-bold text-gray-600 dark:text-gray-400 mb-2 group-focus-within:text-primary-400 transition-colors">المحتوى <span class="text-primary-500">*</span></label>
            ...
            <div class="group">
                <label class="block text-sm font-bold text-gray-600 dark:text-gray-400 mb-2 group-focus-within:text-primary-400 transition-colors">الكلمات المفتاحية (اختياري)</label>
                <div class="relative">
            ...
            <div class="pt-6 flex gap-4">
                ...
                <a href="/knowledge" class="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-bold px-10 py-4 rounded-full hover:bg-gray-700 hover:text-gray-900 dark:text-white transition-colors text-lg">إلغاء</a>
            </div>
        </form>
    </div>
</div>
